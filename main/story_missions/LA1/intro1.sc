...
ENDWHILE
	...
	SET_RELATIONSHIP ACQUAINTANCE_TYPE_PED_RESPECT PEDTYPE_GANG_FLAT PEDTYPE_MISSION2 // FIXEDGROVE: make ballas respect the ones inside the voodoo
	SET_RELATIONSHIP ACQUAINTANCE_TYPE_PED_HATE PEDTYPE_GANG_GROVE PEDTYPE_MISSION2 // FIXEDGROVE: and make it so groves hate them
		...
		IF NOT IS_CHAR_DEAD drive_by_char1 //FREEZE DRIVE_BY_CAR
			IF NOT IS_CHAR_DEAD drive_by_char2
				IF NOT IS_CAR_DEAD drive_by_car
					...
					// FIXEDGROVE: START - deleted some pointless lines, warp them into the car, otherwise they fall off the map and reappear on the surface
