...
IF outsidearea51_d8flag = 5
	...
	IF trackingmode_d8flag = 2
		//remove tower stuff
		SHUT_CHAR_UP scplayer FALSE // FIXEDGROVE: player is able to speak again if discovered
		REMOVE_BLIP blastdoor_d8blip
...
IF inside_d8flag = 2
	...
	IF helptext_d8flag < 8
		...
		IF helptext_d8flag = 6
			IF TIMERB > 6000
				PRINT_HELP DST8_32 //To hover in the jetpack hold down ~h~R2 and L2 simultaneously~w~. // FIXEDGROVE: restored from consoles
				TIMERB = 0
				helptext_d8flag = 7
			ENDIF
		ENDIF
...
CREATE_PICKUP_WITH_AMMO IRGOGGLES PICKUP_ON_STREET_SLOW 1 -2224.6802 129.1278 1035.6200 goggle_pickups[3]       // inside zeros toy shop // FIXEDGROVE
