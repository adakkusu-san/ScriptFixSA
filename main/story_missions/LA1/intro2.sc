...
SET_CHAR_HEADING ryder 176.0 // FIXEDGROVE: Was 'scplayer'
...
mission_intro2_passed:
	...
	IF added_all_food_blips_before = 0
		...
		ADD_SHORT_RANGE_SPRITE_BLIP_FOR_COORD -1451.0, 2595.0, 16.8 RADAR_SPRITE_BARBERS extra_blips[0] // FIXEDGROVE: use new var for blip to preverse vanilla offsets
		...
		ADD_SHORT_RANGE_SPRITE_BLIP_FOR_COORD 1367.0, 248.6, 25.0 RADAR_SPRITE_PIZZA extra_blips[1] // FIXEDGROVE: added blip to pizza stack in montgomery
