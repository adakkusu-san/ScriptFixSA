...
//REQUEST_MODEL cigar // FIXEDGROVE: comment, not used
...
OR NOT HAS_MODEL_LOADED MICRO_UZI // FIXEDGROVE
	WAIT 0

ENDWHILE

//WHILE NOT HAS_MODEL_LOADED cigar // FIXEDGROVE: comment, not used
...
//SET_PED_DENSITY_MULTIPLIER 0.0
	...
	//MARK_MODEL_AS_NO_LONGER_NEEDED WMYBELL
	//MARK_MODEL_AS_NO_LONGER_NEEDED cigar // FIXEDGROVE: comment, not used
...
CLOSE_SEQUENCE_TASK kill_them_all_sweet3
	...
	CREATE_CHAR_AS_PASSENGER sweet_car PEDTYPE_MISSION1 SPECIAL02 2 sweet // FIXEDGROVE: swapped smoke's and sweet's passenger seats
	SET_ANIM_GROUP_FOR_CHAR sweet gang2
	SET_CHAR_HEADING sweet 167.8
	SET_NEXT_DESIRED_MOVE_STATE PEDMOVE_WALK
	TASK_ENTER_CAR_AS_PASSENGER sweet sweet_car 10000 2
	...
	CREATE_CHAR_AS_PASSENGER sweet_car PEDTYPE_MISSION1 SPECIAL01 1 big_smoke // FIXEDGROVE: swapped smoke's and sweet's passenger seats
	SET_ANIM_GROUP_FOR_CHAR big_smoke fatman
	SET_CHAR_HEADING big_smoke 84.5
	SET_NEXT_DESIRED_MOVE_STATE PEDMOVE_WALK
	TASK_ENTER_CAR_AS_PASSENGER big_smoke sweet_car 10000 1
...
GIVE_WEAPON_TO_CHAR drive_by_bloke[0] WEAPONTYPE_MICRO_UZI 99999 // FIXEDGROVE: weapon was TEC9
SET_CURRENT_CHAR_WEAPON drive_by_bloke[0] WEAPONTYPE_MICRO_UZI // FIXEDGROVE: weapon was TEC9
...
GIVE_WEAPON_TO_CHAR drive_by_bloke[1] WEAPONTYPE_MICRO_UZI 99999 // FIXEDGROVE: weapon was TEC9
SET_CURRENT_CHAR_WEAPON drive_by_bloke[1] WEAPONTYPE_MICRO_UZI // FIXEDGROVE: weapon was TEC9
...
SET_RELATIONSHIP ACQUAINTANCE_TYPE_PED_RESPECT PEDTYPE_GANG_FLAT PEDTYPE_MISSION2 // FIXEDGROVE
SET_RELATIONSHIP ACQUAINTANCE_TYPE_PED_HATE PEDTYPE_GANG_GROVE PEDTYPE_MISSION2 // FIXEDGROVE
...
mission_cleanup_sweet3:
	...
	CLEAR_RELATIONSHIP ACQUAINTANCE_TYPE_PED_RESPECT PEDTYPE_GANG_FLAT PEDTYPE_MISSION2 // FIXEDGROVE
	CLEAR_RELATIONSHIP ACQUAINTANCE_TYPE_PED_HATE PEDTYPE_GANG_GROVE PEDTYPE_MISSION2 // FIXEDGROVE
