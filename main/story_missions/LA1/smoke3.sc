...
//					SET_TRAIN_SPEED train_s3 25.0
		...
		IF firstcutscene_s3flag = 15
			IF NOT IS_CHAR_DEAD big_smoke
				...
				SWITCH_ROADS_OFF 2221.43 -1721.07 10.09 2174.01 -1727.2 15.73 // FIXEDGROVE: y2 was '-172.72'
		...
		IF mex2dead_s3flag = 1
			IF mex3dead_s3flag = 1
				IF mex4dead_s3flag = 1
					...
					SWITCH_ROADS_BACK_TO_ORIGINAL 2261.14 -1141.45 18.0 2308.19 -1156.38 35.0 // FIXEDGROVE: remove rather than turn on
					SWITCH_ROADS_BACK_TO_ORIGINAL 2270.69 -1391.75 20.28 2315.81 -1375.58 26.88 // FIXEDGROVE: remove rather than turn on
//					SWITCH_ROADS_ON 2268.75 -1390.8 20.86 2330.03 -1375.53 23.10 // FIXEDGROVE: commented, it's never turned off and it seems to be a bigger and earlier version of the one above
					SWITCH_ROADS_BACK_TO_ORIGINAL 2257.3 -1491.95 20.63  2299.7 -1477.32 26.12 // FIXEDGROVE: remove rather than turn on
					SWITCH_ROADS_BACK_TO_ORIGINAL 2235.25 -1656.59 12.68 2176.75 -1629.89 15.0 // FIXEDGROVE: remove rather than turn on
					SWITCH_ROADS_BACK_TO_ORIGINAL 2221.43 -1721.07 10.09 2174.01 -1727.2 15.73 // FIXEDGROVE: remove rather than turn on. y2 was '-172.72'
					SWITCH_ROADS_BACK_TO_ORIGINAL 2234.09 -1723.3 14.0 2178.22 -1742.47 10.0 // FIXEDGROVE: remove rather than turn on
					SWITCH_ROADS_BACK_TO_ORIGINAL 2261.14 -1141.45 18.0 2308.19 -1156.38 35.0 // FIXEDGROVE: remove rather than turn on
					SWITCH_ROADS_BACK_TO_ORIGINAL 1956.91 -1936.01 10.07 1965.61 -1978.99 14.45 // FIXEDGROVE: remove rather than turn on
					SWITCH_ROADS_BACK_TO_ORIGINAL 2181.3 -1892.0 10.0 2222.36 -1897.71 15.0 // FIXEDGROVE: remove rather than turn on
					smoke_s3flag = 3		
				ENDIF
			ENDIF
		ENDIF
