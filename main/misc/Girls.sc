...
//--- NURSE GIRL (SUZIE)
	...
	iGFLikesOnDate[SUZIE] = 0
		...
		SET_BIT iGFLikesOnDate[SUZIE] LIKES_STUNTS // FIXEDGROVE		
		SET_BIT iGFLikesOnDate[SUZIE] LIKES_TO_GO_FAST // FIXEDGROVE
		SET_BIT iGFLikesOnDate[SUZIE] LIKES_ENTERTAINMENT_ZONES
		SET_BIT iGFLikesOnDate[SUZIE] LIKES_RICH_ZONES // FIXEDGROVE: was LIKES_SHOPPING_ZONES
