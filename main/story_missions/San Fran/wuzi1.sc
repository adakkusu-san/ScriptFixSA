...
wz1_initialise_stuff:
	...
	SET_RELATIONSHIP ACQUAINTANCE_TYPE_PED_RESPECT PEDTYPE_GANG_TRIAD PEDTYPE_MISSION2 // FIXEDGROVE: make triads like wuzi
	SET_RELATIONSHIP ACQUAINTANCE_TYPE_PED_RESPECT PEDTYPE_MISSION2 PEDTYPE_GANG_TRIAD // FIXEDGROVE: make triads like wuzi
...
//	ENDIF
	...
	IF wz1_cut_flag = 7
		IF TIMERA > wz1_cut_time
			...
			SET_NEAR_CLIP 0.1 // FIXEDGROVE: added to avoid windscreen clipping
			wz1_cut_flag = 8
		ENDIF
	ENDIF
...
mission_wuzi1_passed:
	...
	// FIXEDGROVE: START - now triads are friendly to the grove after this mission
	SET_RELATIONSHIP ACQUAINTANCE_TYPE_PED_LIKE PEDTYPE_GANG_TRIAD PEDTYPE_PLAYER1
	SET_RELATIONSHIP ACQUAINTANCE_TYPE_PED_LIKE PEDTYPE_GANG_TRIAD PEDTYPE_GANG_GROVE
	SET_RELATIONSHIP ACQUAINTANCE_TYPE_PED_LIKE PEDTYPE_GANG_GROVE PEDTYPE_GANG_TRIAD 
	// FIXEDGROVE: END 
